...
# project directory
PRJDIR = C:\source\agon-mos
PRJDIR_ESCSPACE = C:\source\agon-mos

# intermediate files directory
WORKDIR = C:\source\agon-mos\Debug
WORKDIR_ESCSPACE = C:\source\agon-mos\Debug

# output files directory
OUTDIR = C:\source\agon-mos\Debug\
OUTDIR_ESCSPACE = C:\source\agon-mos\Debug\
...
clean: 
	...
	@if exist "$(WORKDIR)\mos.src"  \
            $(RM) "$(WORKDIR)\mos.src"
	@if exist "$(WORKDIR)\mos_editor.obj"  \
            $(RM) "$(WORKDIR)\mos_editor.obj"
	@if exist "$(WORKDIR)\mos_editor.lis"  \
            $(RM) "$(WORKDIR)\mos_editor.lis"
	@if exist "$(WORKDIR)\mos_editor.lst"  \
            $(RM) "$(WORKDIR)\mos_editor.lst"
	@if exist "$(WORKDIR)\mos_editor.src"  \
            $(RM) "$(WORKDIR)\mos_editor.src"
	@if exist "$(WORKDIR)\mos_api.obj"  \
            $(RM) "$(WORKDIR)\mos_api.obj"
	@if exist "$(WORKDIR)\mos_api.lis"  \
            $(RM) "$(WORKDIR)\mos_api.lis"
	@if exist "$(WORKDIR)\mos_api.lst"  \
            $(RM) "$(WORKDIR)\mos_api.lst"
	...
	@if exist "$(WORKDIR)\misc.lst"  \
            $(RM) "$(WORKDIR)\misc.lst"
	@if exist "$(WORKDIR)\vdp_protocol.obj"  \
            $(RM) "$(WORKDIR)\vdp_protocol.obj"
	@if exist "$(WORKDIR)\vdp_protocol.lis"  \
            $(RM) "$(WORKDIR)\vdp_protocol.lis"
	@if exist "$(WORKDIR)\vdp_protocol.lst"  \
            $(RM) "$(WORKDIR)\vdp_protocol.lst"
...
OBJS =  \
            ...
            $(WORKDIR_ESCSPACE)\mos_editor.obj  \
            $(WORKDIR_ESCSPACE)\mos_api.obj  \
            $(WORKDIR_ESCSPACE)\misc.obj  \
            $(WORKDIR_ESCSPACE)\vdp_protocol.obj  \
...
$(WORKDIR_ESCSPACE)\main.obj :  \
            ...
            $(PRJDIR_ESCSPACE)\src\clock.h  \
            $(PRJDIR_ESCSPACE)\src\config.h  \
            $(PRJDIR_ESCSPACE)\src\defines.h  \
...
$(WORKDIR_ESCSPACE)\mos.obj :  \
            ...
            $(PRJDIR_ESCSPACE)\src\defines.h  \
            $(PRJDIR_ESCSPACE)\src\mos.h  \
            $(PRJDIR_ESCSPACE)\src\mos_editor.h  \
            $(PRJDIR_ESCSPACE)\src\uart.h  \
            $(PRJDIR_ESCSPACE)\src_fatfs\ff.h  \
            $(PRJDIR_ESCSPACE)\src_fatfs\ffconf.h
...
$(WORKDIR_ESCSPACE)\mos_editor.obj :  \
            $(PRJDIR_ESCSPACE)\src\mos_editor.c  \
            $(INCLUDE_ESCSPACE)\std\FLOAT.H  \
            $(INCLUDE_ESCSPACE)\std\Format.h  \
            $(INCLUDE_ESCSPACE)\std\Stdarg.h  \
            $(INCLUDE_ESCSPACE)\std\Stdio.h  \
            ...
            $(PRJDIR_ESCSPACE)\src_fatfs\ff.h  \
            $(PRJDIR_ESCSPACE)\src_fatfs\ffconf.h
	 $(CC) $(CFLAGS) "$(PRJDIR)\src\mos_editor.c"

$(WORKDIR_ESCSPACE)\mos_api.obj :  \
            $(PRJDIR_ESCSPACE)\src\mos_api.asm
	 $(AS) $(ASFLAGS) "$(PRJDIR)\src\mos_api.asm"
...
$(WORKDIR_ESCSPACE)\vdp_protocol.obj :  \
            $(PRJDIR_ESCSPACE)\src\vdp_protocol.asm  \
            $(PRJDIR_ESCSPACE)\src\equs.inc  \
            $(PRJDIR_ESCSPACE)\src\macros.inc
	 $(AS) $(ASFLAGS) "$(PRJDIR)\src\vdp_protocol.asm"

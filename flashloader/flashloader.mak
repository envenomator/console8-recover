...
# project directory
PRJDIR = C:\source\flashloader
PRJDIR_ESCSPACE = C:\source\flashloader

# intermediate files directory
WORKDIR = C:\source\flashloader\Debug
WORKDIR_ESCSPACE = C:\source\flashloader\Debug

# output files directory
OUTDIR = C:\source\flashloader\Debug\
OUTDIR_ESCSPACE = C:\source\flashloader\Debug\
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\Debug\vdp.src
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\Debug\agontimer.src
	$(AS) $(ASFLAGS) -relist:"C:\source\flashloader\Debug\flashloader.map" \
            C:\source\flashloader\agontimer-timer0.asm
